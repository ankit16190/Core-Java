...
class OuterClass{
	   ...
	   public static class NestedStaticClass{
	    ...
	    public class InnerClass{
	        // can have static method inside innerClass
	    	/*public static void otherMethod(){
				   System.out.println("Other Method from Inner Class"); 
			   }*/
	       // Both static and non-static members of Outer class are accessible in 
	       // this Inner class
	       public void display(){
	          System.out.println("Message from non-static nested class: "+ msg+abc);
	       }
	    }
	} 
	class Main
